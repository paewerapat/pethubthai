...
const post_rate_limit_guard_1 = require("./guards/post-rate-limit.guard");
let PostsController = class PostsController {
    ...
    findAll(page, limit, status, petType, province, amphoe, tambon, category) {
        return this.postsService.findAll(page ? parseInt(page) : 1, limit ? parseInt(limit) : 10, status, petType, province, amphoe, tambon, category);
    }
    findMyPosts(req) {
...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, post_rate_limit_guard_1.PostRateLimitGuard),
